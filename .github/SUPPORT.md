# Getting help with `DeconvoBuddies`

Thank you for using `DeconvoBuddies`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/DeconvoBuddies`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/DeconvoBuddies),
...
[search issues and pull requests](https://github.com/LieberInstitute/DeconvoBuddies/issues)

...
differentially expressed genes (DEGs) can be selected as a set of marker
...
visualize the distribution of `MeanRatio` and `logFC` values.

![Hockey Stick plots compare values of *1vALL* logFC vs. *MeanRatio* and
help select marker
...
Genes with high MeanRatio typically also have high 1vALL fold changes,

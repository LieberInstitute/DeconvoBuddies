...
<p align="center">
![RNAScope/IF measures the cell type proportions through imaging ](http://research.libd.org/DeconvoBuddies/reference/figures/Deconvolution_compare_proprotions.png)
...
Marker genes are genes with cell type specific expression (i.e. high expression 
in one cell type, low expression in other cell types). These genes can be used 
...
## Use `DeconvoBuddies::get_mean_ratio` to calculate the Mean Ratio. 

...
vignette: >
  %\VignetteIndexEntry{Deconvolution Benchmark in Human DLPFC}
...
NOTE: Bisque is no longer available on CRAN (as of July 2025) so cannot be run in this vignette. 
We'll use pre-computed estimates for this vignette instead. (loaded in the next section).

...
bib <- c(
    ...
    sparseMatrixStats = citation("sparseMatrixStats")[1],
...
* `r CRANpkg("graphics")` `r Citep(bib[["graphics"]])`
* `r CRANpkg("grDevices")` `r Citep(bib[["grDevices"]])`
* `r Biocpkg("MatrixGenerics")` `r Citep(bib[["MatrixGenerics"]])`
* `r CRANpkg("methods")` `r Citep(bib[["methods"]])`
...
* `r Biocpkg("sparseMatrixStats")` `r Citep(bib[["sparseMatrixStats"]])`
* `r Biocpkg("spatialLIBD")` `r Citep(bib[["spatialLIBD"]])`
* `r CRANpkg("stats")` `r Citep(bib[["stats"]])`
...
* `r CRANpkg("utils")` `r Citep(bib[["utils"]])`

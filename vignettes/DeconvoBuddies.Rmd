...
There are three pallets to choose from to generate colors or users can provide 
their own color pallet:
...
## Provide a pallet from RColorBrewer
test_cell_colors_brew <- create_cell_colors(
    cell_types = test_cell_types,
    pallet = RColorBrewer::brewer.pal(n=length(test_cell_types), name = "Dark2"),
    preview = TRUE
)

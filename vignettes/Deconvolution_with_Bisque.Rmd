...
BiocManager::install("DeconvoBuddies", "spatialLIBD")
...
We will be be demoning how to use DeconvoBuddies tools when applying deconvolution with the bisque package.

# Access snRNA-seq refrence Dataset

```{r "access_snRNAseq"}
sce_dlpfc <-  spatialLIBD::fetch_data("spatialDLPFC_snRNAseq", type = "sce")

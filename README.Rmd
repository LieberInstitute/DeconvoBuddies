...
data from the human DLPFC from [Huuki-Myers et al., 2024](https://github.com/LieberInstitute/Human_DLPFC_Deconvolution).
...
plot_composition_bar(
    est_prop_long |>
        dplyr::filter(RNum %in% sample(rownames(est_prop_test), 10)),
    x_col = "RNum"
)
```
...
[*lute*](https://doi.org/10.1186/s12864-025-11508-x), with both manuscripts
published with a bi-directional link between them.
...
-   The [documentation website](https://research.libd.org/DeconvoBuddies/) is
...
This package is part of [Bioconductor](https://bioconductor.org/packages/release/bioc/html/DeconvoBuddies.html)
